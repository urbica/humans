...
class ProfessionalClientSwitch extends React.Component {
  render() {
    ...
    const onProfessionalClick = () => dispatch(switchProfessionalClient('professional'));
    const onClientClick = () => dispatch(switchProfessionalClient('client'));

    const professionalClassName = professionalOrClient === 'professional' ? 'tab active' : 'tab';
    const clientClassName = professionalOrClient === 'client' ? 'tab active' : 'tab';
